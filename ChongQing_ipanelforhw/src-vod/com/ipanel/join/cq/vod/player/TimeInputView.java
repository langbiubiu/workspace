...
public class TimeInputView extends RelativeLayout {
	...
	public TimeInputView(Context context) {   
		...
		mDrawNor    = getResources().getDrawable(R.drawable.vod_number_bg);
		mDrawSelect = getResources().getDrawable(R.drawable.vod_time_arrow);
		mColorNor  = Color.parseColor("#F0F0F0");
		mColorSelect = Color.parseColor("#000000");
	}
