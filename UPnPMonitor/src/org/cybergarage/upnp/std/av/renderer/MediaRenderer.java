...
public class MediaRenderer extends Device
{
	...
	public final static String DESCRIPTION = 
		...
		"      <UDN>uuid:362d9414-31a0-48b6-b684-3b4bd38391d0</UDN>\n" +
		"      <serviceList>\n" +
		"         <service>\n" +
...
//		setInterfaceAddress(firstIf);
		...
		service.setActionListener(renCon);
		service.setQueryListener(renCon);

		service = getService(ConnectionManager.SERVICE_TYPE);
		service.setActionListener(conMan);
		service.setQueryListener(conMan);
		
		service = getService(AVTransport.SERVICE_TYPE);
		service.setActionListener(avTrans);
		service.setQueryListener(avTrans);
	}
