...
public class MediaServer extends Device
{
	...
	public MediaServer()
	{
		super();
		try {
			initialize(DESCRIPTION, ContentDirectory.SCPD, ConnectionManager.SCPD, MediaReceiverRegistrar.SCPD);
		}
		catch (InvalidDescriptionException ide) {}
	}

	public MediaServer(String description, String contentDirectorySCPD, String connectionManagerSCPD, String mediaRegistrarSCPD) throws InvalidDescriptionException
	{
		super();
		initialize(description, contentDirectorySCPD, connectionManagerSCPD, mediaRegistrarSCPD);
	}
	
	private void initialize(String description, String contentDirectorySCPD, String connectionManagerSCPD, String mediaRegistrarSCPD) throws InvalidDescriptionException
	{
		...
		Service servMediaReg = getService(MediaReceiverRegistrar.SERVICE_TYPE);
		servMediaReg.loadSCPD(mediaRegistrarSCPD);
...
//		setInterfaceAddress(firstIf);
	...
	private MediaReceiverRegistrar mediaReg;
	
	public MediaReceiverRegistrar getMediaRegistrar(){
		return mediaReg;
	}
