...
import org.cybergarage.http.netty.NettyHTTPServer;
import org.cybergarage.http.netty.NettyHTTPServer.NettyRequestListener;
...
public class Device implements org.cybergarage.http.HTTPRequestListener, SearchListener, NettyRequestListener
{
	////////////////////////////////////////////////
	//	Constants
	////////////////////////////////////////////////
	...
	public final static String DEVICE_ICON_URI = "/icon/device.png";
...
//		Logger.d("UDP Search received: "+ssdpPacket.toString());
...
//		Logger.d(httpReq.toString());
	...
	public void setDeviceIcon(byte[] iconData){
		this.deviceIcon = iconData;
	}
	...
	private void httpGetRequestRecieved(HTTPRequest httpReq)
	{
		...
		} else if (DEVICE_ICON_URI.equals(uri) && deviceIcon != null){
			fileByte = deviceIcon;
		}
   ...
   private void invalidArgumentsControlRecieved(ControlRequest ctlReq)
	...
	private NettyHTTPServer getHTTPServerList() 
	{
	...
	public boolean start()
	{
		...
		NettyHTTPServer httpServerList = getHTTPServerList();

		httpServerList.setRequestListener(this);
		while(UPnP.SERVER_RETRY_COUNT > retryCnt){
			try{
				...
				httpServerList.setPort(bindPort);
			}
		}
...
//		httpServerList.clear();
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
			throws Exception {
		HTTPRequest httpReq = new HTTPRequest(ctx, e);
		httpRequestRecieved(httpReq);
