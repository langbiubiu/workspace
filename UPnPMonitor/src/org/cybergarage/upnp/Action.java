...
public class Action
{
	...
	public boolean postControlAction()
	{
		...
		for (int i = 0; i < actionArgList.size(); i++) {
			Argument argument = actionArgList.getArgument(i);
			System.out.println("argument node name = " + argument.getName() + ", value = " + argument.getValue() + ", direction = " +argument.getDirection());
		}
