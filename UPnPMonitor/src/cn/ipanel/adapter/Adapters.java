...
public class Adapters {
     ...
     */
    public static CursorAdapter loadCursorAdapter(Context context, int id, String uri, String selection,
            Object... parameters) {
        ...
        private void parse(String expression) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (c == '{') {
                    ...
                    String str = expression.substring(segmentStart + 1, i);
                    if("HTTP_HOST".equals(str))
                    	node.next = new ConstantExpressionNode(HTTP_HOST);
                    else
