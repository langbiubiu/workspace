...
public class PFDataGetter {
	public static final String TAG = PFDataGetter.class.getSimpleName();
	Context context;
	...
	HashMap<ChannelKey, PresentAndFollow> map = new HashMap<ChannelKey, PFDataGetter.PresentAndFollow>();
	...
	public PFDataGetter(Context context, String uuid, int flags) {
