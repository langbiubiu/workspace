...
public class NewDvbProviderBase {
	...
	public NewDvbProviderBase(String authority, String contentType, String contentItemType) {
	...
	public void createNetworkTables(SQLiteDatabase db){
	...
	public void createBouquetTables(SQLiteDatabase db){
	...
	public void createEittodayTables(SQLiteDatabase db){
		Log.i(TAG, "ready to createEittodayTables");
		db.execSQL(createEventTableSql);
	}
	
	public void createNetworkTablesByLevel(SQLiteDatabase db, int val){
